...
//    public LogEvent add(ProductPriceFilterDTO product) {
//        if (Objects.nonNull(product)) {
//            this.add(FIELD_UID, product.getUid())
//                    .add(FIELD_NUMBER_OF_PRODUCTS_GROUPED, product.getNumberProductsGrouped())
//                    .add(FIELD_DATE, product.getDate())
//                    .add(FIELD_MIN_PRICE, product.getMinPrice())
//                    .add(FIELD_MAX_PRICE, product.getMaxPrice())
//                    .add(FIELD_AVG_PRICE, product.getAvgPrice());
//        }
//        return this;
//    }
